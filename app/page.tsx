      ...
      <div className="max-w-[1920px] mx-auto relative px-6 md:px-8">
          ...
          <div className="relative w-full px-4 sm:px-6 lg:px-8 text-center pt-[38px] sm:pt-[50px] pb-8 md:pt-[70px] md:pb-12 z-10 flex flex-col h-full">
            ...
            <div className="flex flex-col md:hidden">
              <div className="mb-4">
                ...
                >
                  Instantly automate customer replies with AI across email, chat, and helpdesk platforms.
                </p>
              </div>
              ...
              <div>
                <div className="flex flex-col gap-3 sm:gap-4 mb-4">
                  ...
                  >
                    <Download className="mr-2 h-4 w-4" /> START AUTOMATING SUPPORT
                  </Button>
                  <a
                    href="#waitlist"
            ...
            <div className="hidden md:flex md:flex-col md:flex-grow">
              ...
              >
                Replexify helps businesses respond to their customers in just 10 seconds.
              </p>
        ...
        <section className="pb-12 md:pb-16 bg-black mt-[60px] md:mt-[112px]">
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-6 gap-y-8 sm:gap-y-12 gap-x-6 md:gap-x-8 mb-8 md:mb-12 max-w-6xl mx-auto">
              ...
              <CompanyName name="Intercom" />
              <CompanyName name="Zendesk" />
              <CompanyName name="Discord" />
              <CompanyName name="WhatsApp" noWrapDesktop={true} />
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-y-8 sm:gap-y-12 gap-x-6 md:gap-x-8 max-w-4xl mx-auto">
              <CompanyName name="Microsoft Teams" />
              <CompanyName name="Freshdesk" noWrapDesktop={true} />
              <CompanyName name="Help Scout" noWrapDesktop={true} />
              <CompanyName name="HubSpot" noWrapDesktop={true} />
            </div>
          </div>
        </section>
        ...
        <section className="py-16 md:py-24 bg-black">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 text-center mb-12">
            ...
            >
              From startups to enterprise — trusted worldwide for AI-powered customer support automation.
            </p>
          </div>
