...
const searchQueries: SearchQuery[] = [
  ...
  {
    id: "refunds",
    question: "What's our refund policy for annual subscriptions?",
  ...
  {
    id: "integration",
    question: "How do I integrate with our existing helpdesk?",
  ...
  {
    id: "training",
    question: "How long does it take to train on our documentation?",
  ...
  return (
    <div className="my-24">
      ...
      <div className="text-center mb-6 md:mb-12 px-4">
        ...
        >
          Upload your documentation, FAQs, and policies. Replexify learns your product inside and out to provide accurate, contextual responses.
        </p>
      </div>
                ...
                <div className="flex gap-2 bg-black/50 backdrop-blur-sm rounded-full px-3 py-2">
                  {searchQueries.map((query, index) => (
                    <button
                      ...
                      className={`w-2 h-2 rounded-full transition-all duration-200 ${activeQuery.id === query.id ? "bg-white w-6" : "bg-white/50 hover:bg-white/70"
                        }`}
                    ...
                    <div className="flex flex-col gap-2 w-[240px]">
                      {searchQueries.map((query) => (
                        <button
                          ...
                          className={`group relative text-left p-3 rounded-xl border-2 transition-colors duration-200 ${activeQuery.id === query.id
