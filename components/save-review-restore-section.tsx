...
const features: FeatureData[] = [
  {
    ...
    description: "AI generates human-like responses in seconds — no more waiting for support agents.",
  ...
  },
  {
    id: "train-docs",
    title: "Train on Docs",
    description: "Upload your knowledge base and let AI learn your product inside and out.",
  ...
  {
    id: "smart-escalations",
    title: "Smart Escalations",
    description: "Complex issues automatically routed to human agents — seamless handoffs every time.",
  ...
  return (
    <div className="my-24">
      ...
      <div className="text-center mb-6 md:mb-12 px-4">
        ...
        >
          Instant Replies, Smart Training, Seamless Escalations
        </h2>
        <p
        ...
        >
          Customer support that never sleeps. Replexify handles routine inquiries instantly while intelligently routing complex issues to your team.
        </p>
      </div>
                ...
                <div className="flex gap-2 bg-black/50 backdrop-blur-sm rounded-full px-3 py-2">
                  {features.map((feature, index) => (
                    <button
                      ...
                      className={`w-2 h-2 rounded-full transition-all duration-200 ${activeFeature.id === feature.id ? "bg-white w-6" : "bg-white/50 hover:bg-white/70"
                        }`}
                ...
                <div className="flex gap-4 lg:gap-8 items-end">
                  ...
                  <div className="flex gap-3">
                    {features.map((feature, index) => (
                      ...
                      >
                        <div
                          className={`w-24 h-15 lg:w-32 lg:h-20 rounded-lg overflow-hidden border-2 transition-all duration-200 shadow-lg ${activeFeature.id === feature.id
                        ...
                        <div className="absolute -bottom-6 left-1/2 transform -translate-x-1/2 whitespace-nowrap">
                          <span
                            className={`text-sm font-mono transition-colors duration-200 ${activeFeature.id === feature.id ? "text-white" : "text-white/80"
                              }`}
                            style={{
                              fontFamily: "GeistMono, monospace",
                              textShadow: "0 1px 2px rgba(0,0,0,0.8)",
